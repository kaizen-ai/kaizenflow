...
df = opnsim.get_random_market_data(21)
...
# %%
mode = "instantaneous"
df_5mins = opnsim.resample_data(df, mode)
display(df_5mins)
...
# %%
df, df_5mins = opnsim.get_example_market_data1()
...
w0 = 100.0
final_w, tot_ret, df_5mins = opnsim.compute_pnl_level1(w0, df, df_5mins)
...
tot_ret2, df_5mins = opnsim.compute_lag_pnl(df_5mins)
...
# Level 1 sim.
initial_wealth = 1000
final_w, tot_ret, df_5mins = opnsim.compute_pnl_level1(
...
df_5mins = opnsim.compute_pnl_level2(df, df_5mins, initial_wealth, config)
