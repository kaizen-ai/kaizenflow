...
def process_single_name_result_df(
    ...
    # TODO(Paul): Currently some stats require a `index.freq`. Remove this
    ...
    :param prediction_col: prediction generated by model (e.g., two-step ahead
        prediction of z-scored returns)
