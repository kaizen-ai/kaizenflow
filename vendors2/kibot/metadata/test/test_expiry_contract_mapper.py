...
class TestExpiryContractMapper(hut.TestCase):
    def test_parse_expiry_contract1(self) -> None:
        """Valid input returns valid output"""
        cls = ecm.ExpiryContractMapper()
        inp = 'TTH10'
        exp = ('TT', 'H', '10')
        self.assertTupleEqual(exp, cls.parse_expiry_contract(inp))
    ...
    def test_compare_expiry_contract1(self) -> None:
        ...
        inp = ('TUG10', 'TUF10')
        exp = 1
        self.assertEqual(exp, cls.compare_expiry_contract(*inp))
    ...
    def test_sort_expiry_contract1(self) -> None:
        ...
        self.assertEqual(exp, cls.sort_expiry_contract(inp))
