...
def reconcile_copy_prod_data(
    ...
    system_log_dir = os.path.join(shared_dir, "system_log_dir_manual__2022-11-02T11:40:24.084143+00:00_2hours")
    ...
    log_file = os.path.join(shared_dir, "logs", "log_manual__2022-11-02T11:40:24.084143+00:00_2hours.txt")
