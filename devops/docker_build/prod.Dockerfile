...
# The folder should have the typical aws credentials folder structure (files named config and credentials)
# DO NOT use your personal credentials here -> prod image has its own credentials 
COPY ./aws /home/.aws/
