...
class Test_compare_multiindex_dfs(hunitest.TestCase):
    ...
    def test2(self) -> None:
        """
        - Leave all kwargs empty (excl. "inner" specification and no background_gradient coloring)
        """
        df1, df2 = self.get_multiindex_dfs()
        subset_multiindex_df_kwargs = None
        compare_visually_dataframes_kwargs = {
            "column_mode": "inner",
            "row_mode": "inner",
            "background_gradient": False,
        ...
        expected_length = 5
        expected_column_names = [
            ("asset1_diff", "close_diff"),
            ("asset1_diff", "high_diff"),
            ("asset1_diff", "low_diff"),
            ("asset1_diff", "open_diff"),
            ("asset2_diff", "close_diff"),
            ("asset2_diff", "high_diff"),
            ("asset2_diff", "low_diff"),
            ("asset2_diff", "open_diff"),
        ]
        expected_column_unique_values = None
        expected_signature = r"""# df=
        index=[2022-01-01 21:01:00+00:00, 2022-01-01 21:05:00+00:00]
        columns=('asset1_diff', 'close_diff'),('asset1_diff', 'high_diff'),('asset1_diff', 'low_diff'),('asset1_diff', 'open_diff'),('asset2_diff', 'close_diff'),('asset2_diff', 'high_diff'),('asset2_diff', 'low_diff'),('asset2_diff', 'open_diff')
        shape=(5, 8)
                                asset1_diff                               asset2_diff
        timestamp                  close_diff high_diff  low_diff open_diff  close_diff high_diff  low_diff open_diff
        2022-01-01 21:01:00+00:00    0.508454 -0.849410  1.045419  0.214271    0.183709  1.875197  1.073005 -0.442431
        2022-01-01 21:02:00+00:00   -1.966196 -0.387540  1.174296 -0.080271    0.779532 -1.038852 -1.264697  0.469901
        2022-01-01 21:03:00+00:00    1.593116  0.761005  0.518832  1.149669    1.211659 -1.766080  0.273193 -1.599922
        2022-01-01 21:04:00+00:00   -1.893796  1.905693 -1.720811  0.601601   -1.077636 -0.906465  3.040766  0.245449
        2022-01-01 21:05:00+00:00   -0.251678 -3.344003 -0.808541  0.115062    0.222831  1.036882  0.334238 -2.040374
        """
        self.check_df_output(
            df_diff,
            expected_length,
