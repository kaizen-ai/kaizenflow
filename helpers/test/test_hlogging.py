...
class Test_hlogging_asyncio1(hunitest.TestCase):
    ...
    def test_real_time1(self) -> None:
        ...
        The output is like: ``` 07:55:54 hunit_test.py setUp:932
        Resetting random.seed to 20000101 07:55:54 hunit_test.py
        setUp:935                             Resetting np.random.seed
        to 20000101 07:55:54 hunit_test.py setUp:944
        base_dir_name=/app/amp/helpers/test ```
        """
