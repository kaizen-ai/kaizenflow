...
class MarketData(abc.ABC):
    ...
    def __init__(
        ...
        *,
        ...
        If its value is "assert", an error is raised, if its value is "warn",
        the data is transformed to the expected format with a warning that
        additional transformations were required.
        ...
        #
        hdbg.dassert_in(filter_data_mode, ["assert", "warn"])
