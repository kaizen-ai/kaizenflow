...
#        delay_in_secs: int,
#        # TODO(gp): -> initial_replayed_delay_in_mins=
#        initial_replayed_delay: Union[int, str],
#        *,
...
#        :param initial_replayed_delay: when the replayed wall-clock time starts
#            with respect to the beginning of the data.
#            - E.g., the with `initial_replayed_delay = -5` the data is replayed
...
#                "initial_replayed_delay asset_ids"
#            )
#        )
...
#        #  class.
#        if isinstance(initial_replayed_delay, str):
#            hdbg.dassert_eq(initial_replayed_delay, "last_timestamp")
