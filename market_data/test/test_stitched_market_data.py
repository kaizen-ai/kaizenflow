...
class TestStitchedMarketData1(mdmdteca.MarketData_get_data_TestCase):
    """
...
#             asset_ids
#         )
#         if mdmdteca.skip_test_since_not_online(eg_stitched_market_data):
...
#         if mdmdteca.skip_test_since_not_online(eg_rt_market_data):
#             pytest.skip("Market not on-line")
#         #
#         eg_stitched_market_data = mdlemdaex.get_IgStitchedMarketData_example1(
#             asset_ids
