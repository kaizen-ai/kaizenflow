...
IB_CONNECT_DEV_IMAGE=$(IB_CONNECT_REPO_BASE_PATH):dev
...
ID_CONNECT_RELATED_IMAGES=$(IB_CONNECT_DEV_IMAGE) $(IB_CONNECT_PROD_IMAGE)

ib_connect.setup_print:
	@echo "IB_CONNECT_REPO_BASE_PATH=$(IB_CONNECT_REPO_BASE_PATH)"
	@echo "IB_CONNECT_DEV_IMAGE=$(IB_CONNECT_DEV_IMAGE)"
