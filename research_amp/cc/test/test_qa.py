...
class TestGetBadDataStats(hunitest.TestCase):
    """
    Test `get_bad_data_stats` quality assurance stats by full symbol, year,
    month columns.
    """
    ...
    def _get_crypto_chassis_test_data() -> pd.DataFrame:
        ...
        crypto_chassis_client = (
            iccdc.crypto_chassis_clients.CryptoChassisHistoricalPqByTileClient(
                universe_version,
                resample_1min,
                root_dir,
                partition_mode,
