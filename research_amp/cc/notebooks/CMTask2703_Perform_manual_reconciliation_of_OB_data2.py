...
# - This notebook attempts to correlate 15-min snapshot of 1-second order book data for ETH_USDT resample to 1-min with data obtained daily via CryptoChassis
# - a custom make-do universe "v42" needs to be created in CryptoChassis download and trade universe folder with a single symbol ETH_USDT for this notebook to work
    ...
    param_dict = {
        "data": {
            ...
            "read_data": {
                ...
                "start_ts": pd.Timestamp("2022-09-16 18:30:00+00:00"),
                "end_ts": pd.Timestamp("2022-09-16 18:45:00+00:00"),
                "columns": None,
...
# %%
# The realtime sample has only been done on ETH_USDT
universe = ["binance::ETH_USDT"]
