...
# %%
def get_cmtask2308_config() -> cconconf.Config:
    """
    Get task2308-specific config.
    """
...
binance_bad_data_stats = ramccqa.get_bad_data_stats_bid_ask(
...
binance_bad_data_stats_by_year_month = ramccqa.get_bad_data_stats_bid_ask(
