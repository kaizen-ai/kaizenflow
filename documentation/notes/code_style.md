<!--ts-->
   * [Style guide references](documentation/notes/code_style.md#style-guide-references)
      * [References](documentation/notes/code_style.md#references)
   * [Naming conventions](documentation/notes/code_style.md#naming-conventions)
      * [Finding the best names](documentation/notes/code_style.md#finding-the-best-names)
      * [Horrible names](documentation/notes/code_style.md#horrible-names)
      * [No Hungarian notation please](documentation/notes/code_style.md#no-hungarian-notation-please)
      * [No code stutter](documentation/notes/code_style.md#no-code-stutter)
   * [Comments](documentation/notes/code_style.md#comments)
      * [Docstring conventions](documentation/notes/code_style.md#docstring-conventions)
      * [reST style](documentation/notes/code_style.md#rest-style)
      * [Descriptive vs imperative style](documentation/notes/code_style.md#descriptive-vs-imperative-style)
      * [Use type hints](documentation/notes/code_style.md#use-type-hints)
      * [Replace empty lines in code with comments](documentation/notes/code_style.md#replace-empty-lines-in-code-with-comments)
      * [Avoid distracting comments](documentation/notes/code_style.md#avoid-distracting-comments)
      * [If you find a bug or obsolete docstring/TODO in the code](documentation/notes/code_style.md#if-you-find-a-bug-or-obsolete-docstringtodo-in-the-code)
      * [Referring to an object in code comments](documentation/notes/code_style.md#referring-to-an-object-in-code-comments)
      * [Inline comments](documentation/notes/code_style.md#inline-comments)
   * [Linter](documentation/notes/code_style.md#linter)
      * [Disabling linter messages](documentation/notes/code_style.md#disabling-linter-messages)
      * [Prefer non-inlined linter comments](documentation/notes/code_style.md#prefer-non-inlined-linter-comments)
   * [Logging](documentation/notes/code_style.md#logging)
      * [Always use logging instead of prints](documentation/notes/code_style.md#always-use-logging-instead-of-prints)
      * [Our logging idiom](documentation/notes/code_style.md#our-logging-idiom)
      * [Logging level](documentation/notes/code_style.md#logging-level)
      * [Use positional args when logging](documentation/notes/code_style.md#use-positional-args-when-logging)
      * [Exceptions don't allow positional args](documentation/notes/code_style.md#exceptions-dont-allow-positional-args)
      * [Report warnings](documentation/notes/code_style.md#report-warnings)
   * [Assertions](documentation/notes/code_style.md#assertions)
      * [Use positional args when asserting](documentation/notes/code_style.md#use-positional-args-when-asserting)
      * [Report as much information as possible in an assertion](documentation/notes/code_style.md#report-as-much-information-as-possible-in-an-assertion)
   * [Imports](documentation/notes/code_style.md#imports)
      * [Importing code from a Git submodule](documentation/notes/code_style.md#importing-code-from-a-git-submodule)
      * [Don't use evil import *](documentation/notes/code_style.md#dont-use-evil-import-)
      * [Cleaning up the evil import *](documentation/notes/code_style.md#cleaning-up-the-evil-import-)
      * [Avoid from ... import ...](documentation/notes/code_style.md#avoid-from--import-)
      * [Examples of imports](documentation/notes/code_style.md#examples-of-imports)
      * [Exceptions to the import style](documentation/notes/code_style.md#exceptions-to-the-import-style)
      * [Always import with a full path from the root of the repo / submodule](documentation/notes/code_style.md#always-import-with-a-full-path-from-the-root-of-the-repo--submodule)
      * [Baptizing module import](documentation/notes/code_style.md#baptizing-module-import)
   * [Python scripts](documentation/notes/code_style.md#python-scripts)
      * [Skeleton for a script](documentation/notes/code_style.md#skeleton-for-a-script)
      * [Use the script framework](documentation/notes/code_style.md#use-the-script-framework)
      * [Python executable characteristics](documentation/notes/code_style.md#python-executable-characteristics)
      * [Use clear names for the scripts](documentation/notes/code_style.md#use-clear-names-for-the-scripts)
   * [Functions](documentation/notes/code_style.md#functions)
      * [Arguments](documentation/notes/code_style.md#arguments)
      * [Try to make functions work on multiple types](documentation/notes/code_style.md#try-to-make-functions-work-on-multiple-types)
      * [Avoid hard-wired column name dependencies](documentation/notes/code_style.md#avoid-hard-wired-column-name-dependencies)
   * [Misc (to reorg)](documentation/notes/code_style.md#misc-to-reorg)
      * [Write robust code](documentation/notes/code_style.md#write-robust-code)
      * [Capitalized words](documentation/notes/code_style.md#capitalized-words)
      * [Regex](documentation/notes/code_style.md#regex)
      * [Order of functions in a file](documentation/notes/code_style.md#order-of-functions-in-a-file)
      * [Use layers design pattern](documentation/notes/code_style.md#use-layers-design-pattern)
      * [Write complete if-then-else](documentation/notes/code_style.md#write-complete-if-then-else)
      * [Do not be stingy at typing](documentation/notes/code_style.md#do-not-be-stingy-at-typing)
      * [Research quality vs production quality](documentation/notes/code_style.md#research-quality-vs-production-quality)
      * [No ugly hacks](documentation/notes/code_style.md#no-ugly-hacks)
      * [Life cycle of research code](documentation/notes/code_style.md#life-cycle-of-research-code)
