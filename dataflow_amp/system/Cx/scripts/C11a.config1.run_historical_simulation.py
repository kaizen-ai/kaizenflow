#!/usr/bin/env python
"""
Run historical simulation for model configuration C11a.config1:

https://github.com/cryptokaizen/cmamp/blob/master/docs/trade_execution/ck.model_configurations.reference.md#c11aconfig1
"""
import datetime
import logging
...
if __name__ == "__main__":
    ...
    backtest_config = f"ccxt_v8_1-all.5T.{start_date_as_str}_{end_date_as_str}"
    # Set `ImClient` config.
    im_client_config = {
