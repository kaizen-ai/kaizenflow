...
# Create a CCXT order.
> oms/broker/ccxt/scripts/submit_ccxt_orders.py \
    --exchange_id 'binance' \
...
def _main(parser: argparse.ArgumentParser) -> None:
    ...
    im_client = icdc.get_mock_realtime_client(universe_version, connection)
    ...
    if args.orders_file is None:
        orders = oordorde.orders_from_string(DEFAULT_ORDERS)
    else:
