...
class TestCcOptimizerUtils1(hunitest.TestCase):
    ...
    ccxt_patch = umock.patch.object(obcaccbr, "ccxt", spec=obcaccbr.ccxt)
    # We don't want to interact with real DB in the tests.
    raw_data_reader_patch = umock.patch.object(obcaccbr.imvcdcimrdc, "RawDataReader", create_autospec=True)
    ...
    @staticmethod
    def get_mock_broker() -> obccbrv1.CcxtBroker_v1:
        """
    ...
    def setUp(self) -> None:
        ...
        self.raw_data_reader_mock: umock.MagicMock = self.raw_data_reader_patch.start()
