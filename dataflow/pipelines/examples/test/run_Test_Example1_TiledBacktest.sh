...
#/app/amp/dataflow/model/run_experiment.py --experiment_builder amp.dataflow.model.master_experiment.run_tiled_experiment --config_builder 'dataflow.pipelines.examples.example1_configs.build_tile_configs("kibot_v1-top1.5T.JanFeb2020")' --dst_dir_basename /app/amp/dataflow/pipelines/examples/test/outcomes/Test_Example1_TiledBacktest.test1/tmp.scratch/run_model -v DEBUG --clean_dst_dir --no_confirm --num_threads serial
