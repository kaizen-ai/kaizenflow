...
def main() -> None:
    ...
    #
    tiles_dir = f"/shared_data/backtest.C11a.config3/build_tile_configs.C11a.ccxt_v8_1-all.120T.{start_date_as_str}_{end_date_as_str}.ins.run0/tiled_results"
