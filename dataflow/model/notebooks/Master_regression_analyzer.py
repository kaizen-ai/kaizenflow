...
fit_iter = dtfmodutil.yield_experiment_artifacts(
    src_dir=src_dir,
    file_name=file_name,
    load_rb_kwargs={},
)
...
# %%
dtfmoreana.compute_moments(fit_coeffs, ["p_val_2s"])
...
# %%
feature_stats = dtfmoreana.compute_moments(
...
art_iter = dtfmodutil.yield_experiment_artifacts(
    src_dir=src_dir,
    file_name=file_name,
...
# %%
split1 = dtfmoreana.compute_coefficients(
    src_dir=src_dir,
    file_name=file_name,
...
split2 = dtfmoreana.compute_coefficients(
    src_dir=src_dir,
    file_name=file_name,
    feature_cols=feature_cols,
    target_col=target_col,
