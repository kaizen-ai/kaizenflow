...
# TODO(Dan): "Unify ImClient examples for CCXT and CryptoChassis" CmTask2294.
def get_CryptoChassisHistoricalPqByTileClient_example(
    universe_version: str, dataset:str, contract_type: str, data_snapshot: str
