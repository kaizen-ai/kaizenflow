...
curr_reconcile_command[3] = curr_reconcile_command[3].format(_DAG_BUILDER_CTOR)
...
set_config_value_params = _DAG_CONFIG_PARAMS[_DAG_BUILDER][tag]["run"]
