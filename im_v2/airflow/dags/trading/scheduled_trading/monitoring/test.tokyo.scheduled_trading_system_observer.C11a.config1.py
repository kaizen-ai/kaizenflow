"""
Pre-production scheduled trading system observer DAG that is running when performing
pre-release runs.
...
_DAG_DESCRIPTION = "Pre-production scheduled trading system observer DAG."
# Keep the schedule set for monitoring DAGs because it should run every n-minute. 
_SCHEDULE = "*/5 * * * *"
