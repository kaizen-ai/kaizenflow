...
_DAG_BUILDERS = ["C1b", "C3a", "C5b", "C11a"]
# _DAG_BUILDERS = ["C11a"]
...
_DAG_CONFIG_PARAMS = {
    "C11a": {
        "run": [
            '--set_config_value \'("dag_config","resample","transformer_kwargs","rule"),(str("12T"))\'',
            '--set_config_value \'("market_data_config","days"),(pd.Timedelta(str("13T")))\'',
            '--set_config_value \'("trading_period"),(str("12T"))\'',
            '--set_config_value \'("portfolio_config", "pricing_method"),(str("twap.12T"))\'',
            '--set_config_value \'("process_forecasts_node_dict","process_forecasts_dict","order_config","order_duration_in_mins"),(int(12))\'',
            '--set_config_value \'("process_forecasts_node_dict","process_forecasts_dict","optimizer_config","params","style"),(str("longitudinal"))\'',
            '--set_config_value \'("process_forecasts_node_dict","process_forecasts_dict","optimizer_config","params","kwargs"),({"prediction_abs_threshold": float(0.3)})\'',
        ],
        "reconcile": [
            '--set-config-values \'("dag_config","resample","transformer_kwargs","rule"),(str("12T"));("market_data_config","days"),(pd.Timedelta(str("13T")));("trading_period"),(str("12T"));("portfolio_config", "pricing_method"),(str("twap.12T"));("process_forecasts_node_dict","process_forecasts_dict","order_config","order_duration_in_mins"),(int(12));("process_forecasts_node_dict","process_forecasts_dict","optimizer_config","params","style"),(str("longitudinal"));("process_forecasts_node_dict","process_forecasts_dict","optimizer_config","params","kwargs"),({"prediction_abs_threshold": float(0.3)})\''
        ],
    }
}
_DAG_BAR_DURATION_MIN = {"C1b": 5, "C3a": 5, "C8b": 5, "C5b": 5, "C11a": 12}
_LIVENESS = "CANDIDATE"
_INSTANCE_TYPE = "PROD"
_VERBOSITY = "DEBUG"
_EXCHANGE = "binance"
