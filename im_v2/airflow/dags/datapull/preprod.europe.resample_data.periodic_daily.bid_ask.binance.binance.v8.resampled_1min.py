"""
Resample bid/ask data from 200ms to 1min intervals.
"""
...
_RESAMPLING_JOBS = [
    {
        "src_signature": "periodic_daily.airflow.archived_200ms.parquet.bid_ask.futures.v8.binance.binance.v1_0_0",
        "dst_signature": "periodic_daily.airflow.resampled_1min.parquet.bid_ask.futures.v8.binance.binance.v1_0_0",
    }
]
...
dag = airflow.DAG(
    ...
    catchup=False,
    start_date=datetime.datetime(2024, 3, 24, 0, 0, 0),
