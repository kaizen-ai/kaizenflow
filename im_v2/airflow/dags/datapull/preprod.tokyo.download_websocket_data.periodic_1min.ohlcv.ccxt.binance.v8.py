...
_DOWNLOAD_JOBS = [
    ...
    (_VENDOR, _EXCHANGE, _CONTRACT, _DATA_TYPE, 2),
    (_VENDOR, _EXCHANGE, _CONTRACT, _DATA_TYPE, 3),
    (_VENDOR, _EXCHANGE, _CONTRACT, _DATA_TYPE, 4),
]
...
for vendor, exchange, contract, data_type, _id in _DOWNLOAD_JOBS:
    ...
    curr_download_command[-1] = curr_download_command[-1].format(_CHUNK_SIZE, _id)
