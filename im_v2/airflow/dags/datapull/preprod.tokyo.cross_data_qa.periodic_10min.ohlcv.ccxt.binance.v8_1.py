...
_QA_JOBS = [
    {
        "dataset_signature1": "realtime.airflow.downloaded_1min.postgres.ohlcv.futures.v8_1.ccxt.binance.v1_0_0",
        "dataset_signature2": "periodic_10min.airflow.downloaded_1min.parquet.ohlcv.futures.v8_1.ccxt.binance.v1_0_0",
        "add_invoke_params": []
    },
]
