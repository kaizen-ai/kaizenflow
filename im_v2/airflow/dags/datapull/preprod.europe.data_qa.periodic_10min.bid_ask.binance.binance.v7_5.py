...
_QA_JOBS = [
    ...
    "realtime.airflow.resampled_1min.postgres.bid_ask.futures.v7_5.binance.binance.v1_0_0",
    "realtime.airflow.downloaded_200ms.postgres.bid_ask.futures.v7_5.binance.binance.v1_0_0",
