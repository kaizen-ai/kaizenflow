...
_QA_JOBS = [
    "realtime.airflow.downloaded_200ms.postgres.bid_ask.futures.v7_5.ccxt.cryptocom.v1_0_0",
    "realtime.airflow.resampled_1min.postgres.bid_ask.futures.v7_5.ccxt.cryptocom.v1_0_0",
]
