...
downloading_task = aiutecop.get_ecs_run_task_operator(
    ...
    f"{components_dict['download_mode']}.download.{components_dict['vendor']}.{components_dict['exchange']}.{components_dict['data_type']}.{components_dict['contract_type']}.{components_dict['universe']}",
    download_command,
