...
ecs_task_definition = "cmamp-test-timurg"
...
bash_command = [
    ...
    "--aws_profile 'ck'",
    "--s3_path 's3://{}/{}/{}'",
    "--run_for_min '10'",  # TODO(timurg): fix constant values
    "--interval_min '1'",
]

# Create a DAG.
dag = airflow.DAG(
    dag_id=f"test_{_STAGE}_realtime_periodical_dag",
...
for provider, exchange in product(_PROVIDERS, _EXCHANGES):
    ...
    container_name = "cmamp-test-timurg"
