...
class TestDassertIsFullSymbolValid(hunitest.TestCase):
    def test1(self) -> None:
        ...
        ivcufusy.dassert_is_full_symbol_valid(full_symbol)
...
class TestParseFullSymbol(hunitest.TestCase):
    def test1(self) -> None:
        ...
        exchange, symbol = ivcufusy.parse_full_symbol(full_symbol)
...
class TestConstructFullSymbol(hunitest.TestCase):
    def test1(self) -> None:
        ...
        exchange = "bitfinex"
        symbol = "SOL_USDT"
        full_symbol = ivcufusy.build_full_symbol(exchange, symbol)
