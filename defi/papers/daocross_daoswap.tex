...
\begin{itemize}
  \item force LPs to trade at worse-than-market prices
...
\item conceptual simplicity. Although this is a favorable point for users
  ...
  \item ability to function without a reference price.
  This feature was certainly appealing to initial researchers (e.g., TODO(gp):
  Add ButerinPaper) in search of a fully-decentralized solution to the problem
