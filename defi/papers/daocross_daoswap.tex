...
The main reason why AMM have flourished in crypto is because they can work under severely constrained computational power
This is not necessarily true any more
Off-chain computation
Layer2
- AMM benefits: simplicity guaranteed
- AMM costs: force LPs to trade at worse-than-market prices
- AMM price needs to be corrected by an arbitrageur
We don't think AMM will completely replaced but new mechanisms are needed
LPs need to be compensated with revenues to offset the cost of their adverse selection (quantified and characterized by the LVR paper)
