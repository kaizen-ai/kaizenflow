...
% We could also call Dao* -> TulipCross and TulipSwap.
...
For instance, although the solution of the TulipSwap problem is NP-hard, verifying
...
\begin{itemize}
    ...
    \item Welfare maximization: Yes
          \begin{itemize}
              \item The TulipSwap optimization problem allows to exchange tokens with multiple
                    clearing prices to maximize the aggregated welfare of the participants
          \end{itemize}
    \item Liquidity pooling across tokens: High
          \begin{itemize}
              \item The TulipSwap optimization problem allows to exchange tokens simultaneously across
    ...
    \item Transparency: Yes
          \begin{itemize}
              \item Price discovery, matching, and clearing are either done
                    ...
                    independently verifiable. Thus TulipCross guarantees the requirement
