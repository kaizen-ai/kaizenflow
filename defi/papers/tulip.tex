...
% TODO(gp): @paul feel free to add the "* Authors have contributed equally
% or are in alphabetical order"
...
% TODO(gp): Updat this table once the list of features in the intro is stable
\begin{samepage}
    \begin{table}[h!]
        \centering
        \begin{tabular}{lcccc}
            ...
            \hline
            Low custodial risk              & \textcolor{red}{-}       & \textcolor{green}{+}      & \textcolor{green}{+}   & \textcolor{green}{+}      \\
            High transparency                & \textcolor{red}{-}       & \textcolor{green}{+}    & \textcolor{green}{+} & \textcolor{yellow}{o} \\
            Censorship resistance       & \textcolor{red}{-}        & \textcolor{green}{+}     & \textcolor{green}{+}  & \textcolor{red}{-}        \\
            Intrinsic efficiency        & \textcolor{yellow}{o} & \textcolor{red}{-}       & \textcolor{green}{+} & \textcolor{yellow}{o} \\
            Support for limit orders    & \textcolor{green}{+}     & \textcolor{red}{-}        & \textcolor{green}{+}  & \textcolor{green}{+}     \\
            Low risk of predatory behaviors & \textcolor{red}{-}      & \textcolor{yellow}{o}    & \textcolor{green}{+}  & \textcolor{yellow}{o} \\
            No impermanent loss            & \textcolor{green}{+}      & \textcolor{red}{-}       & \textcolor{green}{+}   & \textcolor{green}{+}      \\
            Multi-coin exchange support & \textcolor{red}{-}       & \textcolor{yellow}{o} & \textcolor{green}{+} & \textcolor{green}{+}    \\
            \hline
        \end{tabular}
    \end{table}
\end{samepage}
...
is polynomial in the number of constraints (or NP-hard in the fully discretized case),
...
\begin{itemize}
    ...
    \item Liquidity pooling across tokens: High
          \begin{itemize}
              \item TulipCross share the same behavior of TulipSwap from this point of view
          \end{itemize}
    \item Liquidity pooling across time: High
          \begin{itemize}
              \item TulipCross share the same behavior of TulipSwap from this point of view
    ...
    \item Rent extracted by high-frequency traders: Medium
          \begin{itemize}
              \item TulipCross behaves as a dark pool of liquidity and thus it can be suscetible
