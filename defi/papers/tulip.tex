...
dominant decentralized alternatives lack this interface. We propose ``TuLiP", a
...
features have immediate and application to improving the efficiency of
...
TuLiP is a new protocol that enables decentralized token
